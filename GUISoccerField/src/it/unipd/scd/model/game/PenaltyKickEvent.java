...
public class PenaltyKickEvent extends GameEvent {
    ...
    public PenaltyKickEvent(int id, int number, Team team, Coordinate coord, double start_time, double end_time) {
        this.id = id;
        this.number = number;
        this.team = team;
    ...
    @Override
    public void draw() {
        FieldPanel.log("As a consequence to the latest foul in " + team.name);
