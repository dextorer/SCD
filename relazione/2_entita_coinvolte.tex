...
In Sezione~\ref{sec:analisi_giocatori} si accenna a come i giocatori prendano decisioni in base allo stato corrente di gioco. Tale stato si compone principalmente dell posizioni degli altri giocatori in campo e dell'andamento del gioco, ad esempio il fatto che la propria squadra sia in fase offensiva o difensiva. Una volta apprese queste informazioni, il giocatore è in grado di scegliere quale mossa sia più opportuna in quella particolare circostanza.\\
