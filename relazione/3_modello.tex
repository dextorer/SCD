...
%\label{sec:modello}
%
%Nella Sezione~\ref{sec:entita_coinvolte} sono state individuate ed analizzate le entita' che caratterizzano il sistema. La fase successiva consiste nel definire le interazioni %che legano le suddette entita', in maniera tale da poter derivare un modello per il sistema.
...
%\subsubsection{Gestione delle fasi di gioco: entita' di gioco}
